...
export const demoSources: DemoSource[] = [
  ...
  },
  {
    ...
    itemsSynced: 342,
    health: 94,
    description: "Slack threads, Telegram notes, onboarding notes, and founder voice snippets.",
  },
  {
    id: "source-linkedin",
    name: "LinkedIn",
  ...
  },
  {
    ...
    itemsSynced: 624,
    health: 90,
    description: "Community questions, customer proof, founder notes, and content requests.",
  },
  {
    id: "source-website",
    name: "Website",
...
export const demoSourceDiscovery: DemoSourceDiscovery = {
  ...
  lookalikes: [
    ...
    { id: "lookalike-005", name: "Nina Brooks", title: "Growth", company: "Northstar Social", score: 81 },
  ],
};
...
export const demoIcpAudience: IcpAudienceMember[] = [
  ...
  },
  {
    ...
    notes: "Strong need for turning technical launches into LinkedIn and X posts with clear engagement follow-up.",
  },
  {
    id: "icp-003",
    name: "Leah Moreno",
  ...
  },
  {
    ...
    source: "LinkedIn",
    status: "Warm",
    lastAction: "LinkedIn reply drafted",
    fit: "Strong",
  ...
  },
  {
    ...
    source: "Website",
    status: "Active",
    lastAction: "LinkedIn post drafted",
    fit: "Moderate",
    intentType: "Search demand",
    notes: "Good target for a proof-led LinkedIn post using owned source material.",
  },
  {
    id: "icp-012",
    name: "Ravi Kapoor",
  ...
  },
  {
    ...
    segment: "Data",
    location: "Phoenix, AZ",
    signal: "Requested relationship tracking examples",
    score: 68,
    source: "LinkedIn",
    status: "New",
    lastAction: "Relationship tracked",
    fit: "Moderate",
    intentType: "Workflow",
  ...
  },
  {
    ...
    fit: "Low",
    intentType: "Search demand",
    notes: "Could become a relationship card after more LinkedIn or X engagement.",
  },
  {
    id: "icp-020",
    name: "Tessa Bloom",
...
export const demoContentFlows: ContentFlow[] = [
  ...
  {
    id: "flow-post-performance",
    name: "Post Performance Loop",
    status: "Review",
    drafts: 7,
    published: 19,
    warmICPs: 53,
  ...
  drafts: [
    {
      ...
      icpFit: "Excellent",
      sourceContext: "3 customer call clips.",
    },
    {
      id: "draft-002",
      type: "draft",
      ...
      icpFit: "Strong",
      sourceContext: "Launch page and Telegram notes.",
    },
    {
      id: "draft-003",
      type: "draft",
      channel: "X",
      title: "X reply from market question",
      source: "X",
      segment: "B2B SaaS",
      status: "Review",
      scheduledFor: "Unscheduled",
      ...
      icpFit: "Moderate",
      sourceContext: "X thread with buyer intent.",
    },
    {
      id: "draft-004",
      type: "draft",
      channel: "LinkedIn",
      title: "LinkedIn post from product update",
      source: "Telegram",
      ...
      icpFit: "Strong",
      sourceContext: "Product update and founder notes.",
    },
  ],
  scheduledPosts: [
    {
      ...
      confidence: 93,
      body: "Short post on turning internal context into daily drafts.",
      icpFit: "Excellent",
    ...
    },
    {
      ...
      confidence: 86,
      body: "Compact thread from the launch note.",
      icpFit: "Strong",
    ...
    },
    {
      ...
      type: "scheduled",
      channel: "LinkedIn",
      title: "Relationship signal recap",
      source: "LinkedIn",
      segment: "Revenue",
      status: "Ready",
      scheduledFor: "Tomorrow 10:00 AM",
      confidence: 89,
      body: "Post on reactions becoming relationship memory.",
      icpFit: "Strong",
      sourceContext: "LinkedIn reactions and warm relationship changes from the last 24 hours.",
    },
    {
      id: "scheduled-004",
      type: "scheduled",
      channel: "X",
      title: "Source context thread",
      source: "Telegram",
      segment: "Product Marketing",
      status: "Review",
      scheduledFor: "Fri 1:00 PM",
      confidence: 81,
      body: "Thread on source material into posts and replies.",
      icpFit: "Moderate",
      sourceContext: "Telegram notes and customer onboarding questions.",
    },
  ],
  suggestedReplies: [
    {
      ...
      scheduledFor: "Now",
      confidence: 94,
      body: "Agree. Keep source context attached so the reply still sounds founder-led.",
      icpName: "Maya Ren",
      signal: "Commented on founder-led post",
      original: "Most AI writing tools lose the source and sound generic.",
      icpFit: "Excellent",
      sourceContext: "LinkedIn comment plus 2 visits.",
    },
    {
      id: "reply-002",
      type: "reply",
      ...
      confidence: 87,
      body: "Separate signal capture from reply drafting. Keep account context attached.",
      icpName: "Sofia Bennett",
      signal: "Asked about reply workflow",
      original: "Post reactions are everywhere. Replies are still manual.",
      icpFit: "Strong",
      sourceContext: "LinkedIn comment and pricing visit.",
    },
    {
      id: "reply-003",
      type: "reply",
      ...
      confidence: 82,
      body: "Start with voice, proof, and timing instead of a blank prompt.",
      icpName: "Elliot Shin",
      signal: "Mentioned content automation",
      original: "Scaling founder content without brand sludge is hard.",
      icpFit: "Strong",
      sourceContext: "X post with category pain.",
    },
    {
      id: "reply-004",
      type: "reply",
      ...
      confidence: 76,
      body: "The differentiator is whether the tool reuses actual source material.",
      icpName: "Amina Cho",
      signal: "Asked market question",
      original: "Any tools that use internal source material?",
      icpFit: "Moderate",
      sourceContext: "Fast X thread on AI content.",
    },
  ],
  publishedPosts: [
    {
      ...
      confidence: 95,
      body: "Start with market signals, not empty calendars.",
      icpFit: "Excellent",
      sourceContext: "Founder-led Content flow.",
    },
    {
      id: "published-002",
      type: "published",
      ...
      confidence: 88,
      body: "Short thread from ICP reactions.",
      icpFit: "Strong",
      sourceContext: "46 LinkedIn engagements.",
    },
    {
      id: "published-003",
      type: "published",
      channel: "LinkedIn",
      title: "Source context for GTM teams",
      source: "Telegram",
      segment: "Product Marketing",
      status: "Published",
      scheduledFor: "Fri 12:05 PM",
      confidence: 84,
      body: "Post on context, publishing, and replies.",
      icpFit: "Strong",
      sourceContext: "Post Performance Loop.",
    },
  ],
};
...
export const demoInsights: DemoInsights = {
  ...
  dailyPerformance: {
    ...
    rows: [
      ...
      {
        id: "daily-post-performance",
        flow: "Post Performance Loop",
        cells: [
  ...
  signalPerformance: [
    ...
    { id: "signal-profile-reactions", signal: "profile reactions", type: "Social", drafts: 12, warmIcps: 5, replies: 3, volume: "Low" },
  ...
  sourcePerformance: [
    ...
    { id: "source-perf-telegram-notes", source: "Telegram", itemsSynced: 342, drafts: 24, warmIcps: 12, lastSync: "11m ago", health: 94 },
    ...
    { id: "source-perf-telegram", source: "Telegram", itemsSynced: 624, drafts: 14, warmIcps: 6, lastSync: "1h ago", health: 90 },
    { id: "source-perf-website", source: "Website", itemsSynced: 118, drafts: 12, warmIcps: 4, lastSync: "2h ago", health: 97 },
    { id: "source-perf-Telegram", source: "Telegram", itemsSynced: 286, drafts: 11, warmIcps: 2, lastSync: "5h ago", health: 84 },
  ],
};
...
export const demoCopilotSuggestions: CopilotSuggestion[] = [
  ...
  },
  {
    ...
    description: "Turn the launch page into LinkedIn and X posts with follow-up replies.",
    source: "Website",
    priority: "High",
    confidence: 89,
    action: "Repurpose",
  },
  {
    ...
    description: "Use post reactions and public signals to create short replies for the warm audience queue.",
    source: "LinkedIn",
    priority: "High",
    confidence: 88,
  ...
  {
    id: "copilot-relationship-cards",
    title: "Create relationship cards",
    description: "Find people who reacted, commented, or replied and add them to relationship memory.",
    source: "LinkedIn",
    priority: "Medium",
    confidence: 82,
    action: "Track people",
...
export const demoCopilotContext: CopilotContextItem[] = [
  ...
  { id: "context-telegram", source: "Telegram", detail: "3 note threads" },
...
export const demoCopilotOutputs: CopilotOutputCard[] = [
  ...
  {
    id: "output-linkedin-reply",
    title: "LinkedIn Reply",
    channel: "LinkedIn",
    preview:
      "Exactly. The difference is whether the system remembers the source context and the relationship history before suggesting the reply.",
    segment: "B2B SaaS",
    source: "LinkedIn",
    confidence: 82,
    voiceMatch: 89,
  },
  {
    ...
    channel: "X",
    preview:
      "The best posting systems do not stop at publishing. They track who reacts, who replies, and who keeps coming back.",
    segment: "Product marketing",
    source: "X",
    confidence: 86,
    voiceMatch: 91,
